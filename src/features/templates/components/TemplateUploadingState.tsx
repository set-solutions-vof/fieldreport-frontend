  ...
  return (
    <section className="flex [width:min(_calc(var(--fr-space-15)_*_3_+_var(--fr-space-8)),_calc(100%_-_var(--fr-space-12))_)] flex-1 flex-col justify-center [gap:var(--fr-space-5)] [margin:var(--fr-space-0)_auto] [padding:var(--fr-space-6)]">
      ...
      <div className="grid [grid-template-columns:1fr] [gap:var(--fr-space-2)]">
        {files.map((file) => (
          <div
            className="flex [min-width:var(--fr-space-0)] items-start [gap:var(--fr-space-3)] [padding:var(--fr-space-3)_var(--fr-space-4)] [background:var(--fr-surface)] [border:var(--fr-border-width-sm)_solid_var(--fr-border)] [border-radius:var(--fr-radius-lg)]"
          ...
          >
            ...
            <span className="flex [min-width:var(--fr-space-0)] flex-1 flex-col [gap:var(--fr-space-1)]">
              <span className="[min-width:var(--fr-space-0)] overflow-hidden [font-size:var(--fr-text-sm)] [font-weight:var(--fr-weight-semibold)] [line-height:var(--fr-leading-snug)] [color:var(--fr-text-primary)] text-ellipsis whitespace-nowrap">
                {file.name}
              </span>
              <span className="[font-variant-numeric:tabular-nums] shrink-0 [font-size:var(--fr-text-xs)] [line-height:var(--fr-leading-snug)] [color:var(--fr-text-secondary)]">
