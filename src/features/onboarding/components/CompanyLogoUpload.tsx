    ...
    <div className="flex flex-col items-start [gap:var(--fr-space-2)] [&>strong]:[font-size:var(--fr-text-sm)] [&>strong]:[font-weight:var(--fr-weight-semibold)] [&>strong]:[line-height:var(--fr-leading-snug)] [&>strong]:[color:var(--fr-text-primary)]">
      ...
      >
        {isUploading ? (
          ...
          <span className="flex items-center [gap:var(--fr-space-5)] text-left [&_strong]:[font-size:var(--fr-text-sm)] [&_strong]:[line-height:var(--fr-leading-snug)] [&_strong]:[color:var(--fr-text-primary)] [&_small]:block [&_small]:[font-size:var(--fr-text-sm)] [&_small]:[line-height:var(--fr-leading-snug)] [&_small]:[color:var(--fr-text-secondary)]">
            <span
            ...
            <span className="flex min-w-0 flex-col [gap:var(--fr-space-1)]">
              <strong>
