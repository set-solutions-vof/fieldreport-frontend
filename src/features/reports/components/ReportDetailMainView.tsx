  ...
  return (
    <>
      <div
        ...
        role="tabpanel"
      >
        <div className="grid [grid-template-columns:280px_minmax(var(--fr-space-0),_1fr)] [align-items:start] [gap:var(--fr-space-6)] [padding:var(--fr-space-6)_var(--fr-space-5)_var(--fr-space-10)]">
          <ReportEvidenceRail
