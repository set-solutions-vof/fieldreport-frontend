...
export function TimelineStripMeta({ range, summary }: TimelineStripMetaProps) {
  return (
    <div className="flex [min-width:var(--fr-space-0)] flex-col [gap:var(--fr-space-1)]">
      ...
      <span className="[font-family:var(--fr-font-mono)] [font-size:var(--fr-text-base)] [font-weight:var(--fr-weight-medium)] [line-height:var(--fr-leading-snug)] [color:var(--fr-text-primary)]">
        {range}
      </span>
