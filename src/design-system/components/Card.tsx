...
export const CardHeader: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  className,
  ...rest
}) => <div className={["fr-card__header", className].filter(Boolean).join(" ")} {...rest} />;

export const CardTitle: React.FC<React.HTMLAttributes<HTMLHeadingElement>> = ({
  className,
  ...rest
}) => <h3 className={["fr-card__title", className].filter(Boolean).join(" ")} {...rest} />;

export const CardSubtitle: React.FC<React.HTMLAttributes<HTMLParagraphElement>> = ({
  className,
  ...rest
}) => <p className={["fr-card__subtitle", className].filter(Boolean).join(" ")} {...rest} />;

export const CardFooter: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({
  className,
  ...rest
}) => <div className={["fr-card__footer", className].filter(Boolean).join(" ")} {...rest} />;
